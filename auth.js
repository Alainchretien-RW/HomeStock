(function () {
    ...
    function setupLogin() {
        if (online() && window.HomeStockOnline.handleOAuthCallback()) {
            window.HomeStockOnline.pull().then(() => { location.href = "index.html"; }).catch(() => { location.href = "index.html"; });
            return;
        }
        ...
        if (googleButton && online()) {
            googleButton.hidden = false;
            googleButton.addEventListener("click", () => {
                window.HomeStockOnline.signInWithGoogle();
            });
        }
